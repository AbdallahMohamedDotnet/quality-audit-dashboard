...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  const { isAr, isDark, activeTab, setActiveTab, ncrs, visitors, archivedAudits } = useAudit();
  ...
  const navItems: NavItem[] = [
    ...
    {
      id: 'audit_form',
      labelAr: 'بدء التدقيق والفحص',
      labelEn: 'Conduct Audit',
    ...
    {
      id: 'ai',
      labelAr: 'محلل الشكاوى بالذكاء الاصطناعي (AI)',
      labelEn: 'AI Complaint & CAPA',
      icon: 'fa-brain',
    },
    {
      id: 'haccp',
      labelAr: 'مسار الهاسب ومصفوفة الاستدعاء',
      labelEn: 'HACCP & Recall Matrix',
      icon: 'fa-shield-halved',
    },
    {
      id: 'visitors',
      labelAr: 'سجل الزوار وإقرارات الصحة والسلامة',
          ...
          {navItems.map(item => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl font-bold text-xs transition-all text-start group ${
                  isActive
              ...
              >
                ...
                {item.badge !== undefined && (
                  <span
                    className={`text-[10px] font-black font-mono px-2 py-0.5 rounded-full shrink-0 shadow-sm ${
