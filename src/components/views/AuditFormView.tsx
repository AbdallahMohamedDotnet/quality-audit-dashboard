    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="w-full md:w-96">
          ...
          <select
            ...
            className="w-full p-2.5 rounded-xl border font-bold text-xs bg-slate-50 dark:bg-slate-950 border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 outline-none focus:border-sky-500 cursor-pointer"
          >
            <option value="">
      ...
      {selectedDept && (
        <div className="sticky top-0 md:top-[var(--header-height,65px)] z-30 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl p-3.5 sm:p-4 border border-slate-200 dark:border-slate-800 shadow-xl space-y-3">
          ...
          {/* Filter Pills */}
          <div className="flex items-center gap-1.5 overflow-x-auto pt-1 text-[11px] font-bold">
            <button
              type="button"
          ...
          <div className="space-y-4">
            {filteredList.map((std, idx) => {
              ...
              return (
                <div
                  key={std.id}
                  className={`bg-white dark:bg-slate-900 rounded-3xl p-5 sm:p-6 border-2 transition-all shadow-sm ${
                    hasAnswer
                      ? isDeviation
                ...
                >
                    ...
                    <div className="flex items-center gap-3 flex-1">
                      <div className="relative flex-1 sm:max-w-xs">
                        <input
                          ...
                          className={`w-full p-2.5 rounded-xl border text-xs font-mono font-bold outline-none transition-colors ${
                            hasAnswer
                              ? isDeviation
                  ...
                  {isDeviation && (
                    <div className="mt-4 p-4 rounded-2xl bg-rose-500/10 border border-rose-500/30 space-y-3 animate-fadeIn">
      ...
      {previewPhoto && (
        <div
          ...
          className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fadeIn cursor-pointer"
        >
